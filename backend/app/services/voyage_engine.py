...
def calculate_voyage(
    ...
    bunker_cost = fuel_mt * bunker_price_usd_mt
    ...
    waiting_cost = waiting_days * daily_hire
    ...
    port_charges = vessel["port_charges_usd"] * 2  # both ends
    ...
    demurrage_cost = demurrage_days * demurrage_usd_day

    # deadheading / repositioning placeholder (small)
    deadhead_cost = distance_nm * 0.15  # very light proxy
    ...
    import math
    # capacity check
    capacity = vessel["typical_dwt"] * 0.95  # approx cargo capacity
    voyages_needed = max(1, math.ceil(cargo_mt / capacity)) if cargo_mt > capacity else 1
    ...
    return {
        ...
        "total_sailing_days_approx": round(total_sailing_days, 2),
